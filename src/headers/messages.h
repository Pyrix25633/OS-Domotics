...
#define POSITION_OFF        0b000000
#define POSITION_ON         0b000001
#define SWITCH_MASK         0b000110
#define SWITCH_POWER        0b000010
#define SWITCH_OPEN         0b000100
#define SWITCH_CLOSE        0b000110
 ...
 * `COMMAND_FORMAT_ERROR` if there was an error in string formatting,
 * `OK` otherwise
 */
 ...
 * 
 * @returns `BUFFER_TOO_SHORT` if the formatted command does not fit in the buffer,
 * `RESPONSE_FORMAT_ERROR` if there was an error in string formatting,
 * `OK` otherwise
 */
